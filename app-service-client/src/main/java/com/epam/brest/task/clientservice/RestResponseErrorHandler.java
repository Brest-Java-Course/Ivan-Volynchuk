...
import com.epam.brest.task.clientservice.Exception.BadDataException;
import com.epam.brest.task.clientservice.Exception.NotFoundException;
...
public class RestResponseErrorHandler implements ResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        ...
        if(statusCode.is4xxClientError()) {
            ...
            switch(statusCode) {
                case BAD_REQUEST:
                    throw new BadDataException(IOUtils.toString(response.getBody(), getCharset(response)),"");
                case NOT_FOUND:
                    throw new NotFoundException(IOUtils.toString(response.getBody(), getCharset(response)),"");
                default:
